...
echo "source ../result/mysql_to_rocks.sql;" |mysql -h$sr_host -P$sr_master_port -uroot -p$sr_password 2>warn.log
...
sh ./e_mysql_to_rocks.sh ../result/new_mysql_to_rocks.sql 2>warn.log
...
#table charges to drop old table and create new table
                ...
                echo "source ../result/new_mysql_to_rocks.sql;" |mysql -h$sr_host -P$sr_master_port -uroot -p$sr_password 2>warn.log
